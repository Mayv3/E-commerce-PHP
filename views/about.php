              ...
              <div class="col-12 col-md-6">
                <div class="d-flex">
                  <div class="me-4 text-primary">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" class="bi bi-gear-fill"
                      viewBox="0 0 16 16">
                      <path
                  ...
                  <div>
                    ...
                    <p class="text-secondary mb-0">Estamos desarrollando una estrategia digital que se manifiesta
                      vibrante en todos los canales y plataformas disponibles.</p>
                  </div>
                </div>
              </div>
              <div class="col-12 col-md-6">
                <div class="d-flex">
                  <div class="me-4 text-primary">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" class="bi bi-fire"
                      viewBox="0 0 16 16">
                      <path
